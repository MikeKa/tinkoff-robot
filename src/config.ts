...
function getStrategyConfig(figi: string): StrategyConfig {
  return {
    ...
    volatility: {
      /** Кол-во точек для сдвига быстрой волатильности */
      fastShift: 20,
      /** Кол-во точек для сдвига медленной волатильности */
      longShift: 40,
      /** Кол-во точек для усреднения быстрой волатильности */
      fastRolling: 40,
      /** Кол-во точек для усреднения медленной волатильности */
      longRolling: 60,
      /** Оконо волатильности */
      volWindow: 200,
      /** Отступ для верхнего уровня */
      stdTop: 0.8,
      /** Отступ для нижнего уровня*/
      stdBtm: 1,
    }
  };
}
